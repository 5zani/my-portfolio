    ...
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section id="about" className="max-w-3xl mx-auto py-16 px-4">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          Mechanics. I am self-driven — independently learning Power BI, Machine Learning, and advanced data analytics
      ...
      <section id="skills" className="bg-white py-16 px-4">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">SQL</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">MongoDB</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">DBeaver</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">JSON</div>
          </div>

          <div>
            <h3 className="font-bold text-blue-600 mb-3">Programming</h3>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Python</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Pandas</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">NumPy</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Selenium</div>
          </div>

          <div>
            <h3 className="font-bold text-blue-600 mb-3">BI & Visualization</h3>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Power BI</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Grafana</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Tableau</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Microsoft Excel</div>
          </div>

          <div>
            <h3 className="font-bold text-blue-600 mb-3">Data Engineering</h3>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">ETL Pipeline Validation</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Data Quality Checks</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">REST API / Postman</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Databricks</div>
          </div>

          <div>
            <h3 className="font-bold text-blue-600 mb-3">Machine Learning</h3>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Scikit-learn</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">OpenCV</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Supervised Learning</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Data Preprocessing</div>
          </div>

          <div>
            <h3 className="font-bold text-blue-600 mb-3">Tools & Workflow</h3>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Git / GitHub</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Jira / Agile</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">VS Code</div>
            <div className="p-2 mb-2 shadow rounded-lg text-center text-sm">Business Intelligence</div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              features, and mapping them to system control events.
            </p>
            <a href="https://github.com/5zani" className="text-blue-600 mt-3 inline-block text-sm">GitHub →</a>
          </div>
